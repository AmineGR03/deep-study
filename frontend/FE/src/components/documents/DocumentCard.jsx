    ...
    <div className="ds-card p-5 hover:border-primary-500/30 transition-all duration-200 hover:shadow-glow group">
      ...
      <div className="flex items-start justify-between gap-3 mb-3">
        ...
        <div className="flex gap-2 shrink-0">
          ...
          <button  onClick={() => onDelete(doc._id)}  className="ds-btn-danger text-xs py-1.5 px-3">🗑️</button>
        </div>)}
      ...
      {fileUrl ? (
        ...
        <p className="text-xs text-dark-500 text-center py-2">Fichier non disponible</p>
      )}
    </div>
  )
}